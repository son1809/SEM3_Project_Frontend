            ...
            <div
              ...
              className={`${
                location.pathname === item.path
                  ...
                  : ""
              } hover:bg-gray-200 cursor-pointer flex items-center space-x-3 py-4 px-6 transition-colors duration-200`}
            >
              {item.icon}
              <span className="hover:text-gray-800 font-medium">{item.label}</span>
            </div>
