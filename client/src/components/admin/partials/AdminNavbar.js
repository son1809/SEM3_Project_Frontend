      ...
      <nav className="sticky z-10 flex items-center shadow-md justify-between px-4 py-4 md:px-8 top-0 w-full bg-white">
        ...
        <div className="flex items-center">
          ...
          >
            ...
            {/* Dropdown Menu */}
            {showDropdown && (
              <div className="userDropdown absolute right-0 mt-1 bg-gray-200 rounded shadow-md z-50">
                <ul className="flex flex-col text-gray-700">
                  <li
                    onClick={() => navigate("/")}
                    className="flex space-x-2 py-2 px-6 hover:bg-gray-400 cursor-pointer"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="none"
                  ...
                  <li className="flex space-x-2 py-2 px-6 hover:bg-gray-400 cursor-pointer">
                    <svg
                      className="w-6 h-6"
                      fill="none"
                      stroke="currentColor"
